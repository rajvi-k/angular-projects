...
@Component({
  selector: 'app-application-age',
  templateUrl: './application-age.component.html',
  styleUrls: ['./application-age.component.css']
})
export class ApplicationAgeComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    for (let group in this.groups) {
      ...
      this.single.push({ name: group + " years", value: this.values[this.count] })
      this.count++
    }
  }
