...
@Component({
    ...
    styleUrls: ['./ui-type.component.css']
})
export class UiTypeComponent implements OnInit {
    ...
    appData: any[] = []
    // appDataAsync: Observable<any>;
    key = "application_layer_dev_language";
    ...
    // showLegend = true;
    showXAxisLabel = true;
    xAxisLabel = 'Dev Language';
    showYAxisLabel = true;
    yAxisLabel = 'Number of Apps';
