...
@Component({
  selector: 'app-country-usage',
  templateUrl: './country-usage.component.html',
  styleUrls: ['./country-usage.component.css']
})
export class CountryUsageComponent implements OnInit {
