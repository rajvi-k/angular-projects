...
@Component({
  selector: 'addatt4',
  templateUrl: './addatt4.component.html',
  styleUrls: ['./addatt4.component.css']
})
export class Addatt4Component implements OnInit {
...
changeTab(){
  ...
  onSubmit(data) {
    this.dirty=false
    this.selectedAttribute.id=''
    console.log("ObjData", data.options, this.category)
    var obj = {}
    if (this.category == undefined) {
